                ...
                Array(3).fill().map((_, idx) => {
                    return (
                        <div key={idx} className={`col-md-4 mb-3 my-5`}>
                            <div className={`card mb-1`} style={{ width: '95%', height: '100%', margin: '0 10px', minHeight: '200px' }} >
                                <div className="row no-gutters">
                                    ...
                                    <div className="col-md-8">
                                        <div className="card-body">
                                            ...
                                            <Skeleton />
                                            <Skeleton />
                                            <Skeleton animation="wave" className='btn btn-light rounded-4 px-5 fw-bold read-btn' width={200} height={50} />
                                        </div>
                                    </div>
                                </div>
                            </div>
