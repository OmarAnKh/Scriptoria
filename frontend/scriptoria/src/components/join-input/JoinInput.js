            ...
            <div className="inputBox">
                <div style={{ position: 'relative', display: 'inline-block' }}>
                    ...
                    <button
                        ...
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="25" fill="currentColor" class="bi bi-eye" viewBox="0 0 16 16" style={{ position: 'absolute', top: '40%', right: '10px', transform: 'translateY(-50%)' }}>
