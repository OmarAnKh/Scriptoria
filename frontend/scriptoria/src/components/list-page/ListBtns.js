...
const ListBtns = ({list, name, setName, update }) => {
  const { auth } = useAuth();
  ...
  return (
    <div>
          ...
          <div>
            {auth?.userInfo._id === list.accountId ? (
              <>
                ...
                <i>
                  <button
                    className="btn btn-danger m-1 text-decoration-none"
                    data-bs-toggle="modal"
                    data-bs-target={`#list-btns-modal-${type}-${list._id}`}
      ...
      <div
        className="modal fade d-normal"
        id={`list-btns-modal-${type}-${list._id}`}
        tabIndex={-1}
                ...
                {type === "delete" ? (
                  ...
                  <>
                    <div className="form text-start">
                      ...
                      <div className="mb-3">
                        <label htmlFor="list-privacy" className="form-label">
                          edit privacy
                        </label>
                        <select
