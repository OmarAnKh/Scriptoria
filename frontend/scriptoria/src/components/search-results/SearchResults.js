            ...
            <div className="row">
                <div className="col text-center">
                    <div className="Search-container">
                        <BookCard
                            imgURL="https://media.discordapp.net/attachments/1101950978435055726/1219311866870890546/image.png?ex=6614122a&is=66019d2a&hm=7dce18d9d23a245464b7a9177ade49287d5f6cd789a247e5721913ed847710bb&=&format=webp&quality=lossless&width=349&height=350"
                            description="A vida ira doazia a menor ideia de quemonquistar a mulher que amava"
                            name="Soul"
                            auther="Ahmad iyrot"
                        />
                        <BookCard
